    ...
    case 'INSTAGRAM':
      return (
        <svg width={px} height={px} viewBox="0 0 40 40">
          ...
          <rect width="40" height="40" rx={r} fill="url(#ig-icon)"/>
    ...
    case 'TELEGRAM':
      return (
        <svg width={px} height={px} viewBox="0 0 40 40">
          ...
          <path d="M13 21.3l11.5 8.2" fill="none" stroke="#d0e6f0" strokeWidth="0.5"/>
        </svg>
      );
...
export default function PlatformIcon({ platform, size = 'md', className = '' }: Props) {
  ...
  const rings: Record<string, string> = {
    FACEBOOK: 'ring-blue-200', INSTAGRAM: 'ring-pink-200', LINKEDIN: 'ring-blue-200',
    TWITTER: 'ring-slate-200', X: 'ring-slate-200', TIKTOK: 'ring-slate-200',
    YOUTUBE: 'ring-red-200', THREADS: 'ring-slate-200', BLUESKY: 'ring-sky-200',
    PINTEREST: 'ring-red-200', WHATSAPP: 'ring-green-200', TELEGRAM: 'ring-sky-200',
    REDDIT: 'ring-orange-200',
  };
  const ring = rings[platform] || 'ring-slate-200';
