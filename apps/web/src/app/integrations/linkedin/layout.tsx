...
export const metadata: Metadata = {
  ...
  description:
    'Connect your LinkedIn Company Pages to eWork Social. Schedule posts, reply to comments, and manage your LinkedIn presence alongside Facebook, Instagram, and more — from one unified dashboard built for African agencies.',
  openGraph: {
