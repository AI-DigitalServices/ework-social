...
export default function BlogPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#080C14', fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* Nav */}
      <nav style={{ borderBottom: '1px solid #1A2840', padding: '0 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64, position: 'sticky', top: 0, background: 'rgba(8,12,20,0.95)', backdropFilter: 'blur(12px)', zIndex: 10 }}>
        ...
        <div style={{ display: 'flex', gap: 24, alignItems: 'center' }}>
          <Link href="/" style={{ color: '#6B8299', fontSize: 14, textDecoration: 'none' }}>Home</Link>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '64px 24px 48px', textAlign: 'center' }}>
        <div style={{ display: 'inline-block', background: 'rgba(37,99,235,0.15)', border: '1px solid rgba(37,99,235,0.3)', borderRadius: 999, padding: '4px 16px', marginBottom: 20 }}>
          <span style={{ color: '#60A5FA', fontSize: 12, fontWeight: 700, letterSpacing: 2 }}>THE eBLOG</span>
        </div>
        <h1 style={{ color: '#F0F6FF', fontSize: 'clamp(32px, 5vw, 52px)', fontWeight: 800, lineHeight: 1.1, margin: '0 0 16px', fontFamily: 'Georgia, serif', letterSpacing: '-1px' }}>
          Insights for Agency Owners<br />
          <span style={{ color: '#2563EB' }}>& Social Media Managers</span>
        </h1>
        <p style={{ color: '#6B8299', fontSize: 17, lineHeight: 1.7, margin: 0, maxWidth: 560, marginLeft: 'auto', marginRight: 'auto' }}>
      ...
      {/* Bottom CTA */}
      <div style={{ borderTop: '1px solid #1A2840', padding: '64px 24px', textAlign: 'center', background: 'rgba(37,99,235,0.03)' }}>
