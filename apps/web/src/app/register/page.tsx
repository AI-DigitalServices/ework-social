    ...
    <div style={{ minHeight: '100vh', background: '#080C14', fontFamily: "'Inter', sans-serif" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .google-btn { width: 100%; padding: 13px 16px; background: #0C1524; border: 1px solid #1A2840; border-radius: 10px; color: #E8F0FA; font-size: 14px; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; display: flex; align-items: center; justify-content: center; gap: 10px; }
        .google-btn:hover { background: #111E30; border-color: #2A3D55; transform: translateY(-1px); }
        .or-divider { display: flex; align-items: center; gap: 12px; margin: 4px 0; }
        .or-line { flex: 1; height: 1px; background: #1A2840; }
        .or-text { color: #2A3A52; font-size: 12px; font-weight: 500; }
        ...
        <div className="reg-right">
          <div className="reg-form-inner" style={{ width: '100%', maxWidth: 400 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              {/* Google Sign-Up — only for normal agency signup, not invite flow */}
              {!isInviteFlow && (
                <>
                  <button
                    type="button"
                  ...
                  <div className="or-divider">
                    ...
                    <span className="or-text">or sign up with email</span>
                    <div className="or-line" />
                  </div>
                </>
              )}
