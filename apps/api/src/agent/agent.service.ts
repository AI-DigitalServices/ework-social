...
export class AgentService {
  ...
  private buildSystemPrompt(campaign: { goal: string; brief: string }, memories: Array<{ kind: string; content: string }>) {
    ...
    return [
      ...
      'Ground content proposals in get_analytics, search_inbox, and (when a client is named)',
      'get_client_context before drafting. Prefer attaching a real asset via search_assets.',
